      ...
      <section className="contact-section">
        <div className="container">
          <div className="reveal" style={{ textAlign: 'center' }}>
            ...
            <p style={{ color: 'var(--text-secondary)' }}>Connect with our artisan lab and support teams.</p>
          </div>

          <div className="contact-grid">
            <a href="https://instagram.com/zimca" target="_blank" rel="noreferrer" className="contact-card reveal">
            ...
            <a href="mailto:zimcaofficial@gmail.com" className="contact-card reveal" style={{ transitionDelay: '0.1s' }}>
              <div className="contact-icon">
              ...
              <h3>Email Us</h3>
              <p>zimcaofficial@gmail.com</p>
            </a>

            <a href="tel:+919025959775" className="contact-card reveal" style={{ transitionDelay: '0.2s' }}>
              <div className="contact-icon">
        ...
        <div className="container">
          <div className="footer-bottom">
            <div className="footer-copyright">
              © 2026 ZIMCA CREATIVE SYNDICATE. ALL RIGHTS RESERVED.
            </div>
            <div className="footer-status">
              <div className="status-dot"></div>
              SYSTEMS OPERATIONAL / V1.0.4
            </div>
          </div>
        </div>
      </footer>
